...
function showDedicationText() { //seguidores
  ...
  if (!text) {
     text = `Para mi querida amiga:\n\nGracias por estar siempre ahí, por escuchar, por compartir risas y momentos que valen oro.\n\nTu amistad es un regalo que la vida me dio, y quiero que sepas que te aprecio muchísimo.\n\nNunca cambies, porque eres una persona increíble. 🌸💫`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, tu amigo";
